...
Loading data from excel file.
    ...
    4. Randomly divide data into training set and testing set.
    5. Transform data into Tensor form, and then return them,
"""
def load_data(file_dir, features_num, label_index, features_selector=[], spliting_ratio=0.8):
    ...
    # Shuffle data and remove the headings of features.
